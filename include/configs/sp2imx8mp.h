...
#ifndef __IMX8MP_SP2_H
#define __IMX8MP_SP2_H
...
#define CONFIG_SYS_VIDEO_LOGO_MAX_SIZE        (512 << 10) /* 512kb */
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootargs=console=ttymxc1,115200 pcie_cz_enabled=${pcie_compliance} net.ifnames=0 earlycon=ec_imx6q,0x30890000,115200 ubi.mtd=nandrootfs "  \
...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"mmcautodetect=yes\0" \
	"mmcargs=setenv bootargs ${jh_clk} ${mcore_clk} console=${console} pcie_cz_enabled=${pcie_compliance} net.ifnames=0 root=${mmcroot}\0 " \
